  ...
  _createClass(GroupPanelHorizontalLayout, [{
    ...
    get: function get() {
      var _this$props2 = this.props,
          ...
          restProps = _objectWithoutProperties(_this$props2, ["baseColSpan", "className", "columnCountPerGroup", "groupByDate", "groupOrientation", "groups", "groupsRenderData", "height", "resourceCellTemplate", "styles"]);
