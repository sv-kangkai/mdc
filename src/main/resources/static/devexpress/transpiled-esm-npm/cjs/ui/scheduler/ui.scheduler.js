...
var Scheduler = /*#__PURE__*/function (_Widget) {
  ...
  _proto.getWorkSpaceScrollableScrollTop = function getWorkSpaceScrollableScrollTop(allDay) {
    return this._workSpace.getGroupedScrollableScrollTop(allDay);
  };

  _proto.getWorkSpaceScrollableScrollLeft = function getWorkSpaceScrollableScrollLeft() {
  ...
  _proto.getWorkSpaceAllDayHeight = function getWorkSpaceAllDayHeight() {
    return this._workSpace.getAllDayHeight();
  };

  _proto.getWorkSpaceAllDayOffset = function getWorkSpaceAllDayOffset() {
    return this._workSpace.getAllDayOffset();
  };

  _proto.getWorkSpaceHeaderPanelHeight = function getWorkSpaceHeaderPanelHeight() {
