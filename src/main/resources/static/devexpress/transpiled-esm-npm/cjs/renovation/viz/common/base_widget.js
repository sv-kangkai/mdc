    ...
    get: function get() {
      var _this$props$canvas = _extends({}, this.props, {
        canvas: this.__state_canvas
          ...
          restProps = _objectWithoutProperties(_this$props$canvas, ["canvas", "canvasChange", "children", "className", "classes", "defaultCanvas", "disabled", "margin", "onContentReady", "pointerEvents", "rootElementRef", "rtlEnabled", "size"]);
