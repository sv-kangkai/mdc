  ...
  _createClass(TooltipItemLayout, [{
    ...
    get: function get() {
      var _this$props3 = this.props,
          ...
          restProps = _objectWithoutProperties(_this$props3, ["className", "getTextAndFormatDate", "index", "item", "itemContentTemplate", "onDelete", "onHide", "showDeleteButton", "singleAppointment"]);
