    ...
    get: function get() {
      var _this$props$canvas = _extends({}, this.props, {
        canvas: this.__state_canvas
          ...
          restProps = _objectWithoutProperties(_this$props$canvas, ["canvas", "canvasChange", "children", "className", "classes", "color", "defaultCanvas", "disabled", "endScaleValue", "margin", "onContentReady", "onTooltipHidden", "onTooltipShown", "pointerEvents", "rtlEnabled", "showTarget", "showZeroLevel", "size", "startScaleValue", "target", "targetColor", "targetWidth", "tooltip", "value"]);
