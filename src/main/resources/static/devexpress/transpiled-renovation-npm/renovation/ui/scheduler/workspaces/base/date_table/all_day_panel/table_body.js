  ...
  _createClass(AllDayPanelTableBody, [{
    ...
    get: function get() {
      var _this$props = this.props,
          ...
          restProps = _objectWithoutProperties(_this$props, ["className", "dataCellTemplate", "isVerticalGroupOrientation", "leftVirtualCellCount", "leftVirtualCellWidth", "rightVirtualCellCount", "rightVirtualCellWidth", "viewData"]);
