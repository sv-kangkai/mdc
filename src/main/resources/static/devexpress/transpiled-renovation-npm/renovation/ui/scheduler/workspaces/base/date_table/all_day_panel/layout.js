  ...
  _createClass(AllDayPanelLayout, [{
    ...
    get: function get() {
      var _this$props = this.props,
          ...
          restProps = _objectWithoutProperties(_this$props, ["addDateTableClass", "bottomVirtualRowHeight", "className", "dataCellTemplate", "groupOrientation", "leftVirtualCellWidth", "rightVirtualCellWidth", "topVirtualRowHeight", "viewData", "visible"]);
